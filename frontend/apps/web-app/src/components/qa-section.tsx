...
export function QASection({
  ...
  return (
    <section
      ...
      className={cn(
        "sm:w-full md:w-3xl px-5 mx-auto max-w-5xl flex flex-col items-center justify-center mt-4", // צמצום הרווח פה
        className
      )}
    >
      <h2 className="text-3xl md:text-4xl font-bold text-brand-dark text-center mb-10">
