...
const CONDITION_FIELDS = [
  ...
  {
    value: "processing.region",
    label: "Region",
    type: "string",
    description: "Geographic region (derived from countryISO)",
    category: "Geography",
    isDynamic: true,
  },
  {
    ...
    label: "Bundle Group",
    type: "enum",
    description: "The bundle group category (derived from bundle)",
    category: "Bundle",
    isDynamic: true,
  },
  {
  ...
  {
    value: "processing.selectedBundle.validityInDays",
  ...
  },
  {
    ...
    label: "Data Type",
    type: "enum",
    description: "Whether the bundle has unlimited or fixed data",
    examples: ["unlimited", "fixed"],
    category: "Bundle",
    isDynamic: false,
  },
  {
    value: "response.unusedDays",
    label: "Unused Days",
    type: "number",
  ...
  {
    value: "response.pricing.totalCost",
    label: "Total Cost",
    type: "number",
