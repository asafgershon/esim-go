 ...
 * 
 * @export
 * @interface EsimsIccidSmsPostRequest
 */
export interface EsimsIccidSmsPostRequest {
    /**
     * UTF-8 compliant message
     * @type {string}
     * @memberof EsimsIccidSmsPostRequest
     */
    'message'?: string;
    /**
     * Name of sender that will show in SMS.  This defaults to `eSIM` and is the only supported value by default. Unique identifiers can be assigned to your Organisation on request. 
     * @type {string}
     * @memberof EsimsIccidSmsPostRequest
     */
    'from'?: string;
