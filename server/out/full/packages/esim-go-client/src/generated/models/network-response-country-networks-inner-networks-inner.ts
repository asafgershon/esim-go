 ...
 * 
 * @export
 * @interface NetworkResponseCountryNetworksInnerNetworksInner
 */
export interface NetworkResponseCountryNetworksInnerNetworksInner {
    /**
     * Network name
     * @type {string}
     * @memberof NetworkResponseCountryNetworksInnerNetworksInner
     */
    'name'?: string;
    /**
     * Brand network name
