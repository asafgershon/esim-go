...
// @ts-ignore
import type { BundlesListBundlesInner } from './bundles-list-bundles-inner';

/**
 * 
 * @export
 * @interface BundlesList
 */
export interface BundlesList {
    /**
     * 
     * @type {Array<BundlesListBundlesInner>}
     * @memberof BundlesList
     */
    'bundles'?: Array<BundlesListBundlesInner>;
}
