 ...
 * 
 * @export
 * @interface InventoryResponseBundlesInnerAvailableInner
 */
export interface InventoryResponseBundlesInnerAvailableInner {
    /**
     * The ID of the available bundle
     * @type {number}
     * @memberof InventoryResponseBundlesInnerAvailableInner
     */
    'id'?: number;
    /**
    ...
    'total'?: number;
    /**
     * The remaining number of bundles
     * @type {number}
     * @memberof InventoryResponseBundlesInnerAvailableInner
     */
    'remaining'?: number;
    /**
     * The expiry date of the bundle
     * @type {string}
     * @memberof InventoryResponseBundlesInnerAvailableInner
     */
    'expiry'?: string;
