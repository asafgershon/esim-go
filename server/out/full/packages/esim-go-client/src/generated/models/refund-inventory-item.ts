 ...
 * 
 * @export
 * @interface RefundInventoryItem
 */
export interface RefundInventoryItem {
    /**
     * The usage id for the refund. Can be found by querying \"Get bundle inventory\" endpoint
     * @type {number}
     * @memberof RefundInventoryItem
     */
    'usageId'?: number;
    /**
