 ...
 * 
 * @export
 * @interface InventoryResponseBundlesInnerAllowancesInner
 */
export interface InventoryResponseBundlesInnerAllowancesInner {
    /**
     * Type of allowances (DATA, SMS, VOICE)
     * @type {string}
     * @memberof InventoryResponseBundlesInnerAllowancesInner
     */
    'type'?: string;
    /**
     * Service (Roaming, Standard)
     * @type {string}
     * @memberof InventoryResponseBundlesInnerAllowancesInner
     */
    'service'?: string;
    ...
    'unit'?: string;
    /**
     * Indicates if the allowance is unlimited
     * @type {boolean}
     * @memberof InventoryResponseBundlesInnerAllowancesInner
     */
    'unlimited'?: boolean;
