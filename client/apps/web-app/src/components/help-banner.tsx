...
export function HelpBanner() {
  ...
  return (
    <section className="py-20 md:py-32 relative overflow-hidden rounded-[2.5rem] mx-4 md:mx-8 my-8">
      {/* Background Images */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Button
            ...
            className="bg-white text-[#1E293B] hover:bg-white/90 font-semibold px-8 py-4 text-base rounded-full shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all inline-flex items-center gap-2"
          >
            לשליחת הודעה
            <svg 
              width="24" 
