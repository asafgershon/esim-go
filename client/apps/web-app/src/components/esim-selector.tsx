...
export function EsimSelector() {
  ...
  const { getPricing } = useBatchPricing({
    regionId:
      ...
      <SelectorContent>
        ...
        <SelectorSection>
          ...
          {isMobile ? (
            <div className="relative">
              <div className="
                bg-brand-white border border-[rgba(10,35,46,0.2)] rounded-lg 
            ...
            <div className="relative">
              <FuzzyCombobox
                ...
                className="[&>button]:bg-brand-white [&>button]:border [&>button]:border-[rgba(10,35,46,0.2)] [&>button]:rounded-lg [&>button]:md:rounded-[15px] [&>button]:h-[34px] [&>button]:md:h-[60px] [&>button]:hover:border-brand-purple [&>button]:transition-colors [&>button]:text-[12px] [&>button]:md:text-[18px]"
              />
            </div>
          )}
        </SelectorSection>
        ...
        <SelectorSection>
          ...
          <div className="text-right">
            <button 
              className="text-[10px] md:text-[12px] leading-[26px] font-bold text-brand-dark hover:text-brand-purple transition-colors cursor-pointer"
          ...
          <div className="bg-brand-white border border-[rgba(10,35,46,0.2)] rounded-lg md:rounded-[15px] p-3 md:p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="text-brand-dark opacity-50 hover:opacity-100 text-sm p-1"
              >
                ✕
              </button>
            </div>
            ...
            <div className="pt-3 border-t border-[rgba(10,35,46,0.1)]">
              ...
              {pricing?.hasDiscount && (
                <div className="text-center py-1 text-[8px] md:text-[10px] bg-green-50 rounded text-green-600">
    ...
    <>
      <SelectorHeader className="mb-0 min-h-10 relative">
        ...
        <button
          ...
          className="absolute top-0 left-0 md:left-auto md:right-0 p-2 hover:bg-gray-100 rounded-full transition-colors cursor-pointer"
        >
          <CloseIcon />
        </button>
      </SelectorHeader>
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-8">
          ...
          <SelectorSection className="flex-1 gap-3">
            <div className="flex items-center gap-2 justify-start">
              ...
              <p className="text-[14px] md:text-[20px] text-brand-dark">ממתי?</p>
            </div>
            {/* PLACEHOLDER INPUT - Replace with actual date picker */}
            <div className="bg-brand-white border border-[rgba(10,35,46,0.2)] rounded-[15px] md:rounded-[20px] h-[120px] md:h-[174px] flex items-center justify-center">
          ...
          <SelectorSection className="flex-1 gap-3">
            <div className="flex items-center gap-2 justify-start">
              <CalendarIcon className="w-[14px] h-[14px] md:w-[17px] md:h-[17px]" />
              <p className="text-[14px] md:text-[20px] text-brand-dark">עד מתי?</p>
            </div>
            {/* PLACEHOLDER INPUT - Replace with actual date picker */}
            <div className="bg-brand-white border border-[rgba(10,35,46,0.2)] rounded-[15px] md:rounded-[20px] h-[120px] md:h-[174px] flex items-center justify-center">
              <span className="text-gray-400 text-[12px] md:text-[14px]">Date Picker Placeholder</span>
  ...
  return (
    <Selector>
      <SelectorCard>
        {currentView === 'datePicker' ? <DatePickerView /> : <MainView />}
      </SelectorCard>
    </Selector>
  );
}