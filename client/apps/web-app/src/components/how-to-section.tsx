          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-lg text-gray-300 mb-12 leading-relaxed text-center">
                קחו מספר דקות וה-eSIM כבר אצלכם בטלפון. אפשר
                <br />
                להתקין את ה-eSIM כבר מהבית, והוא יתחיל
                <br />
                לפעול אוטומטית לאחר הנחיתה בעוד.
              </p>
                    ...
                    <div className="absolute inset-[8px] bg-gray-900 rounded-[22px] overflow-hidden">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center p-8">
                          ...
                          <p className="text-white text-lg font-semibold">החבילה שלכם מוכנה לשימוש</p>
                        </div>
                      </div>
                    </div>
                  </div>
