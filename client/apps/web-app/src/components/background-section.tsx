...
export function BackgroundSection({ children }: BackgroundSectionProps) {
  ...
  useEffect(() => {
    ...
    // Cleanup function
    return () => {
      gsap.killTweensOf(desktopSvgRef.current?.querySelectorAll('path') || []);
      gsap.killTweensOf(mobileSvgRef.current?.querySelectorAll('path') || []);
    };
  }, []);
      ...
      >
        ...
        <defs>
          <linearGradient id="greenGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="100%" stopColor="var(--color-brand-green)" stopOpacity="0.95" />
          </linearGradient>
          <linearGradient id="greenGradient2" x1="100%" y1="100%" x2="0%" y2="0%">
            <stop offset="0%" stopColor="var(--color-brand-green)" />
            <stop offset="100%" stopColor="var(--color-brand-green)" stopOpacity="0.95" />
          </linearGradient>
          <radialGradient id="purpleGradient" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="var(--color-brand-purple)" />
            <stop offset="100%" stopColor="var(--color-brand-purple)" stopOpacity="0.96" />
          </radialGradient>
      ...
      >
        ...
        <defs>
          <linearGradient id="mobileGreen1" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="var(--color-brand-green)" stopOpacity="0.9" />
            <stop offset="100%" stopColor="var(--color-brand-green)" stopOpacity="0.7" />
          </linearGradient>
          ...
          <radialGradient id="mobilePurple1" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="var(--color-brand-purple)" stopOpacity="0.8" />
            <stop offset="100%" stopColor="var(--color-brand-purple)" stopOpacity="0.6" />
          </radialGradient>
