...
type Documents = {
    ...
    "\n  query CalculatePricing($numOfDays: Int!, $regionId: String!, $countryId: String!, $showAdminBreakdown: Boolean = false) {\n    calculatePrice(numOfDays: $numOfDays, regionId: $regionId, countryId: $countryId, showAdminBreakdown: $showAdminBreakdown) {\n      bundleName\n      countryName\n      duration\n      cost\n      costPlus\n      totalCost\n      discountRate\n      discountValue\n      priceAfterDiscount\n      processingRate\n      processingCost\n      revenueAfterProcessing\n      finalRevenue\n      currency\n      adminBreakdown {\n        baseCostSplitPercent\n        baseDiscountRate\n        baseProcessingRate\n        costMargin\n        costPlusMargin\n        totalMargin\n        grossProfit\n        netProfit\n        profitMarginPercent\n        estimatedEsimGoCost\n        ourMarkup\n        markupPercent\n        dailyRate\n        competitiveAnalysis\n      }\n    }\n  }\n": typeof types.CalculatePricingDocument,
