...
export type CalculateAdminPriceQuery = { __typename?: 'Query', calculatePrice: { __typename?: 'PricingBreakdown', duration: number, currency: string, totalCost: number, discountValue: number, priceAfterDiscount: number, cost: number, costPlus: number, discountRate: number, processingRate: number, processingCost: number, finalRevenue: number, netProfit: number, discountPerDay: number, unusedDays?: number | null, selectedReason?: string | null, totalCostBeforeProcessing?: number | null, bundle: { __typename?: 'CountryBundle', id: string, name: string, duration: number, isUnlimited: boolean, data?: number | null, group?: string | null, country: { __typename?: 'Country', iso: any, name: string }, appliedRules?: Array<{ __typename?: 'AppliedRule', name: string, category: RuleCategory, impact: number }> | null }, country: { __typename?: 'Country', iso: any, name: string, nameHebrew?: string | null, region?: string | null, flag?: string | null }, appliedRules?: Array<{ __typename?: 'AppliedRule', name: string, category: RuleCategory, impact: number }> | null, discounts?: Array<{ __typename?: 'DiscountApplication', type: string, amount: number }> | null } };
...
export type CalculateBatchAdminPricingQuery = { __typename?: 'Query', calculateBatchPricing: Array<{ __typename?: 'PricingBreakdown', duration: number, currency: string, totalCost: number, discountValue: number, priceAfterDiscount: number, cost: number, costPlus: number, discountRate: number, processingRate: number, processingCost: number, finalRevenue: number, netProfit: number, discountPerDay: number, unusedDays?: number | null, selectedReason?: string | null, totalCostBeforeProcessing?: number | null, bundle: { __typename?: 'CountryBundle', id: string, name: string, duration: number, isUnlimited: boolean, data?: number | null, group?: string | null, country: { __typename?: 'Country', iso: any, name: string }, appliedRules?: Array<{ __typename?: 'AppliedRule', name: string, category: RuleCategory, impact: number }> | null }, country: { __typename?: 'Country', iso: any, name: string, nameHebrew?: string | null, region?: string | null, flag?: string | null }, appliedRules?: Array<{ __typename?: 'AppliedRule', name: string, category: RuleCategory, impact: number }> | null, discounts?: Array<{ __typename?: 'DiscountApplication', type: string, amount: number }> | null }> };
