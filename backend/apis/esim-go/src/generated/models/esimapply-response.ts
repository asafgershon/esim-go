...
// @ts-ignore
import type { ESIMApplyResponseEsimsInner } from './esimapply-response-esims-inner';

/**
 * 
 * @export
 * @interface ESIMApplyResponse
 */
export interface ESIMApplyResponse {
    /**
     * 
     * @type {Array<ESIMApplyResponseEsimsInner>}
     * @memberof ESIMApplyResponse
     */
    'esims'?: Array<ESIMApplyResponseEsimsInner>;
    /**
     * Apply Reference
     * @type {string}
     * @memberof ESIMApplyResponse
