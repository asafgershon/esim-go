 ...
 * 
 * @export
 * @interface BundlesListBundlesInnerAssignmentsInner
 */
export interface BundlesListBundlesInnerAssignmentsInner {
    /**
     * ID of assignment
     * @type {string}
     * @memberof BundlesListBundlesInnerAssignmentsInner
     */
    'id'?: string;
    /**
     * Type of the bundle
