...
// @ts-ignore
import type { BundlesListBundlesInnerAssignmentsInner } from './bundles-list-bundles-inner-assignments-inner';

/**
 * 
 * @export
 * @interface BundlesListBundlesInner
 */
export interface BundlesListBundlesInner {
    /**
     * Name of the bundle
     * @type {string}
     * @memberof BundlesListBundlesInner
     */
    'name'?: string;
    /**
    ...
    /**
     * 
     * @type {Array<BundlesListBundlesInnerAssignmentsInner>}
     * @memberof BundlesListBundlesInner
     */
    'assignments'?: Array<BundlesListBundlesInnerAssignmentsInner>;
}
