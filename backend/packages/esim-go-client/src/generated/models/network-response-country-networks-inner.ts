...
// @ts-ignore
import type { NetworkResponseCountryNetworksInnerNetworksInner } from './network-response-country-networks-inner-networks-inner';

/**
 * 
 * @export
 * @interface NetworkResponseCountryNetworksInner
 */
export interface NetworkResponseCountryNetworksInner {
    /**
     * Country ISO (internationally recognized means of identifying countries)
     * @type {string}
     * @memberof NetworkResponseCountryNetworksInner
     */
    'name'?: string;
    /**
     * 
     * @type {Array<NetworkResponseCountryNetworksInnerNetworksInner>}
     * @memberof NetworkResponseCountryNetworksInner
     */
    'networks'?: Array<NetworkResponseCountryNetworksInnerNetworksInner>;
}
