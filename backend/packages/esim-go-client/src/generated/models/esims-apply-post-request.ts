...
// @ts-ignore
import type { ApplyBundleWithICCIDRequest } from './apply-bundle-with-iccidrequest';
// May contain unused imports in some cases
// @ts-ignore
import type { ApplyBundleWithList } from './apply-bundle-with-list';
// May contain unused imports in some cases
// @ts-ignore
import type { ApplyBundleWithListBundlesInner } from './apply-bundle-with-list-bundles-inner';

/**
 * @type EsimsApplyPostRequest
 * @export
 */
export type EsimsApplyPostRequest = ApplyBundleWithICCIDRequest | ApplyBundleWithList;
