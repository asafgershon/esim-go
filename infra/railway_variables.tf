...
locals {
  ...
  # apollo_server_id will be created by railway_apollo_server.tf
  ...
  # Apollo Server specific variables - Production
  apollo_server_vars = {
    PORT                    = "5001"
    CORS_ORIGINS           = "https://manage.hiiloworld.com,https://hiiloworld.com"
    DASHBOARD_URL          = "https://manage.hiiloworld.com/"
    ...
    # CDN URL
    CDN_URL                = "https://${aws_cloudfront_distribution.hiilo_cdn_prod.domain_name}"
  }
  
  # Apollo Server specific variables - Development
  apollo_server_vars_dev = {
    PORT                    = "5001"
    CORS_ORIGINS           = "*"  # More permissive in dev
    ...
    ESIM_GO_API_KEY        = var.esim_go_api_key
    ESIM_GO_BASE_URL       = "https://api.esim-go.com"
    ESIM_GO_MODE           = "mock"  # Use mock mode in development
    ESIM_GO_WEBHOOK_SECRET = var.esim_go_webhook_secret
    ...
    # CDN URL
    CDN_URL                = "https://${aws_cloudfront_distribution.hiilo_cdn_dev.domain_name}"
  }
}

# Apollo Server Environment Variables - Now managed in railway_apollo_server.tf
# Commented out because apollo_server service doesn't exist yet
